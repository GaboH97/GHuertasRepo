...
insert into TC_PERSONA (SPID ,SCNOMBRE, SCNUMIDENTIFICACION) VALUES(SEQ_PERSONA.nextval,'Gabriel',12345678);
insert into TC_PERSONA (SPID ,SCNOMBRE, SCNUMIDENTIFICACION) VALUES(SEQ_PERSONA.nextval,'Javier',27694734);
insert into TC_PERSONA (SPID ,SCNOMBRE, SCNUMIDENTIFICACION) VALUES(SEQ_PERSONA.nextval,'Maria',97462992);

--Crear una secuencia para utilizarla como incremento del identificador
CREATE SEQUENCE "DB_SEMILLERO"."SEQ_USUARIO" MINVALUE 1 START WITH 1 INCREMENT BY 1 NOCACHE;

insert into TC_USUARIO (SUID ,SUNOMBRE, SUFECHA_CREACION,SUESTADO, SUIDPERSONA) VALUES(SEQ_USUARIO.nextval,'G2xe',sysdate,'ACTIVO',1);
insert into TC_USUARIO (SUID ,SUNOMBRE, SUFECHA_CREACION,SUESTADO, SUIDPERSONA) VALUES(SEQ_USUARIO.nextval,'V0pxic',sysdate,'ACTIVO',1);
insert into TC_USUARIO (SUID ,SUNOMBRE, SUFECHA_CREACION,SUESTADO, SUIDPERSONA) VALUES(SEQ_USUARIO.nextval,'T9faxyo',sysdate,'ACTIVO',1);
